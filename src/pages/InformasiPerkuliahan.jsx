...
export default function InformasiPerkuliahan({ pmb }) {
  const title = "Informasi Perkuliahan";
  return (
    <main>
      <Head title={title} />
      <section className="p-12 w-full">
        ...
        <p className="text-center mb-5 font-bold">Informasi Perkuliahan Meliputi Informasi Alur Pendaftaran, Pesyaratan, dan Informasi Umum</p>
